    ...
    return (
        <div className="space-y-6">
                ...
                <CardHeader className="bg-gradient-to-r from-slate-50 to-white border-b px-6 py-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-xl font-bold text-slate-800">Manajemen Siswa</CardTitle>
                                <CardDescription className="text-slate-500">
                                    Kelola data siswa {adminData.role === "ADMIN" ? "di kelas Anda" : "seluruh sekolah"}
                                </CardDescription>
                            </div>
                        </div>
                        <Button
                ...
                <CardContent className="p-0">
                    {loading ? (
                        ...
                        <div className="text-center py-16 text-slate-500 flex flex-col items-center gap-3">
                            ...
                            <div>
                                <p className="font-medium text-slate-900">Belum ada data siswa</p>
                                <p className="text-sm">Silakan tambahkan siswa baru untuk memulai</p>
                            </div>
                        </div>
                    ) : (
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-xl bg-white">
                    <DialogHeader className="p-6 pb-2 bg-slate-50 border-b border-slate-100">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="h-10 w-10 rounded-full bg-emerald-50 flex items-center justify-center">
                                <User className="h-5 w-5 text-emerald-600" />
                            </div>
                            <DialogTitle className="text-xl">Tambah Siswa Baru</DialogTitle>
                        </div>
                        <DialogDescription>
                    ...
                    <div className="p-6 space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="nisn" className="text-sm font-medium text-slate-900 dark:text-slate-900">NISN</Label>
                                <div className="relative">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="class" className="text-sm font-medium text-slate-900 dark:text-slate-900">Kelas</Label>
                                <Select
                                    value={formData.class}
                                    onValueChange={(val) => setFormData({ ...formData, class: val })}
                                >
                                    <SelectTrigger id="class" className="pl-10 relative focus:ring-emerald-500/20">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="phone" className="text-sm font-medium text-slate-900 dark:text-slate-900">
                                No. HP <span className="text-slate-400 font-normal text-xs ml-1">(Opsional)</span>
                            </Label>
                            <div className="relative">
                ...
                <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden border-none shadow-xl bg-white">
                    <DialogHeader className="p-6 pb-2 bg-slate-50 border-b border-slate-100">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <DialogTitle className="text-xl">Edit Data Siswa</DialogTitle>
                        </div>
                        <DialogDescription>
                            Perbarui informasi untuk <span className="font-medium text-slate-800">{selectedStudent?.name}</span>.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="p-6 space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                <Label htmlFor="edit-nisn" className="text-sm font-medium text-slate-900 dark:text-slate-900">NISN</Label>
                                <div className="relative">
                                    <Hash className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                                    <Input
                                        id="edit-nisn"
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="edit-class" className="text-sm font-medium text-slate-900 dark:text-slate-900">Kelas</Label>
                                <Select
                                    value={formData.class}
                                    onValueChange={(val) => setFormData({ ...formData, class: val })}
                                >
                                    <SelectTrigger id="edit-class" className="pl-10 relative focus:ring-blue-500/20">
                                        <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                                        <SelectValue placeholder="Pilih kelas" />
                                    </SelectTrigger>
                                    <SelectContent>
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="edit-phone" className="text-sm font-medium text-slate-900 dark:text-slate-900">
                                No. HP <span className="text-slate-400 font-normal text-xs ml-1">(Opsional)</span>
                            </Label>
                            <div className="relative">
                                <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent className="sm:max-w-[425px] bg-white">
                    <AlertDialogHeader className="flex flex-col items-center justify-center text-center sm:text-center">
                        ...
                        <AlertDialogTitle className="text-xl">Hapus Siswa?</AlertDialogTitle>
                        <AlertDialogDescription className="text-center pt-2">
                            Anda akan menghapus siswa <span className="font-semibold text-slate-900">{selectedStudent?.name}</span> (NISN: {selectedStudent?.nisn}).
                            <br />
