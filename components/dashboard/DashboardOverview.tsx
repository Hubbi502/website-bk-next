                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-slate-600">{typeof visit.class === 'object' ? (visit.class as any).name : visit.class || '-'}</p>
              ...
              {visits.slice(0, 5).map((visit) => (
                <div key={visit.id} className="flex items-start gap-3 p-3 rounded-lg hover:bg-slate-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-500">{typeof visit.class === 'object' ? (visit.class as any).name : visit.class || '-'} • {visit.visitDate}</p>
                    <div className="mt-1">
                      {getStatusBadge(visit.status)}
                    </div>
                  </div>
